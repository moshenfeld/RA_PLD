...
) -> DenseLinearDiscreteDist | DenseGeometricDiscreteDist:
    """
...
def discretize_continuous_to_pmf(
    ...
    if spacing_type == SpacingType.GEOMETRIC:
        return DenseGeometricDiscreteDist.from_x_array(
            x_array=x_array,
            PMF_array=PMF_array,
            p_neg_inf=p_neg_inf,
            p_pos_inf=p_pos_inf,
...
def change_spacing_type(dist: DiscreteDistBase,
                        ...
                        spacing_type: SpacingType,
                        bound_type: BoundType) -> DenseLinearDiscreteDist | DenseGeometricDiscreteDist:
